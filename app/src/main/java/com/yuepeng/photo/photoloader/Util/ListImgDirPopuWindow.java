package com.yuepeng.photo.photoloader.Util;
...
import com.yuepeng.photo.photoloader.R;
...
public class ListImgDirPopuWindow extends PopupWindow {
    ...
    private class ListDirAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(context).load(bean.getFirstImgDir()).into(vh.mImg);
            vh.mCount.setText(bean.getCount()+"");
            vh.mDir.setText(bean.getName());
